...
MVTec_CLASS_NAMES = ['bottle', 'cable', 'capsule', 'carpet', 'grid', 'hazelnut',
...
class MVTecDataset(Dataset):
    def __init__(self, root_path='D:/Dataset/mvtec_anomaly_detection/', class_name='bottle', is_train=True,
